...
class Server:
    ...
    def start_server(self):
        ...
        while True:
            ...
            # Encrypt secret with the client public key
...
if __name__ == "__main__":
    # Port required as an argument that will be used to open the socket with localhost (127.0.0.1)
    arg_parse = argparse.ArgumentParser()
    arg_parse.add_argument("-p", "--port", type=int, required=True, help="port to open the server")
